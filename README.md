# genpark-nlp-to-geojson-spatial-feature-compiler-skill
...
**genpark-nlp-to-geojson-spatial-feature-compiler-skill** is a deterministic, zero-dependency Python skill engineered for autonomous geospatial analysis, GeoJSON feature generation, and spatial reachability intelligence.

> **Executive Capability**: Natural language to validated GeoJSON FeatureCollection compiler (Atlas.new)
...
result = client.compile_spatial_query()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-nlp-to-geojson-spatial-feature-compiler-skill": {
      "command": "python",
      "args": ["/path/to/genpark-nlp-to-geojson-spatial-feature-compiler-skill/mcp_server.py"]
    }
  }
}
```
